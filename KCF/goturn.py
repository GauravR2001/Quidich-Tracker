...
tracker = cv2.TrackerGOTURN_create()  # Or other tracker like cv2.TrackerGOTURN_create()
...
while True:
    ...
    cv2.putText(frame, f"Average FPS: {int(average_fps)}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 2)
